...
<head>
    ...
    <style>
        .category-header {
            height: 400px;
            background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('<?= BASEURL; ?>/assets/image/aksesoris.jpeg?v=1');
...
<body>
    ...
    <footer>
        ...
        <div class="footer-bottom">
            <p>&copy; 2026 TokoOnline Premium Accessories. Semua Hak Dilindungi.</p>
