<?php $this->view('templates/header', $data); ?>
    ...
    <style>
        .category-header {
            height: 350px;
            background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=1920&q=80');
            ...
            <div class="bento-item <?= $classes[$i % 6]; ?> reveal">
                ...
                <div class="item-overlay">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 15px;">
                        <span style="font-weight: 800; font-size: 1.2rem; background: #80d8ff; color: #000; padding: 2px 10px; border: 2px solid #000;">Rp <?= number_format($produk['harga'], 0, ',', '.'); ?></span>
